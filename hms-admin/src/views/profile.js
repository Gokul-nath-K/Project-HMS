            ...
            <div className="container-fluid py-4">
                ...
                <div className="col-md-12">
                    ...
                    <div className="card-header pb-0">
                        ...
                        <button className="btn btn-primary btn-sm ms-auto">Edit</button>
                        </div>
                    </div>
                    <div className="card-body">
                        ...
                        <div className="col-md-6">
                            ...
                            <input className="form-control" type="text" defaultValue="A" />
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="form-group">
                            <label htmlFor="example-text-input" className="form-control-label">Admin - Code</label>
                            <input className="form-control" type="text" defaultValue="100" />
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="form-group">
                            <label htmlFor="example-text-input" className="form-control-label">Blood - Group</label>
                            <input className="form-control" type="text" defaultValue="B+" />
                            </div>
                        </div>
                        </div>
